...
namespace FINEST_DIAMOND_WOO_ADDON\inc\Traits;
...
trait Singleton {
	...
	final public static function get_instance() {
		...
		if ( ! isset( $instance[ $called_class ] ) ) {
			...
			/**
			 * Dependent items can use the `FINEST_DIAMOND_WOO_ADDON_singleton_init_{$called_class}` hook to execute code
			 */
			do_action( sprintf( 'FINEST_DIAMOND_WOO_ADDON_singleton_init_%s', $called_class ) ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores

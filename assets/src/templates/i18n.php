    ...
    foreach ($files as $file) {
        if ($file !== '.' && $file !== '..' && is_file($directory . '/' . $file)) {
            ...
            foreach ($matches as $match) {
                ...
                $translationValue = "__('" . addslashes($translationValue) . "', 'domain')"; // Replace 'mydomain' with your actual domain
...
$directory = 'C:/xampp/htdocs/teddy-bear/wp-content/plugins/finest-diamond-woo-addon/assets/src/templates/scan/frontend'; // frontend
